...
import { ExternalLink, Github, Eye, Code, Palette, Workflow } from 'lucide-react';
    ...
    <section id="projects" className="py-10 sm:py-14 md:py-20 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {sections.map((section, secIndex) => (
          <div key={section.id} className="mb-12 sm:mb-16 lg:mb-20 last:mb-0">
            {/* Section Header */}
            <motion.div
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 xl:gap-8">
              {projects
                .filter((p) => p.category === section.filter)
                .map((project, index) => {
                  ...
                  return (
                    ...
                    >
                      {/* Project Thumbnail */}
                      <div className="relative h-36 xs:h-40 sm:h-44 lg:h-48 overflow-hidden">
                        {project.video ? (
                          <video
                            src={project.video}
                            autoPlay
                      ...
                      <div className="p-3 xs:p-4 sm:p-5 lg:p-6">
                        ...
                        <div className="mb-3 sm:mb-4">
                          <p className="text-[10px] xs:text-xs font-medium text-accent mb-1.5 sm:mb-2">
                            Role: {project.role}
                          </p>
            ...
            {/* Add GitHub Button only after Web Projects */}
            {section.id === 'web-projects' && (
              ...
              >
                <Button
                  ...
                  onClick={() =>
                    window.open('https://github.com/qayyums3116', '_blank')
                  }
                >
